<template>
  <el-table id="dataTable" ref="dataForm" @sort-change="sortChange" :data="createformlist" style="width: 960px" show-summary :summary-method="getSummaries">
    <el-table-column prop="creativeId" fixed label="创意ID" width="100">
    </el-table-column>
    <el-table-column prop="adCreativeName" fixed label="创意名称" width="160">
    </el-table-column>
