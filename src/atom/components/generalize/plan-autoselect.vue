<template>
    <el-dialog title="智能选择" :visible.sync="dialogFormVisible" class="dialog autodialog" @close="toCancel">
        <el-form ref="form" :model="form" label-width="80px" class="cform">
            ...
            <el-form-item label="选择策略" class="cline">
                ...
                <el-tooltip class="item" effect="dark" content="不同策略会选到不同的创意，请根据需求选择合适的策略" placement="top-start">
